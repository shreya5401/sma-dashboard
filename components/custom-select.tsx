  ...
  return (
    <SelectPrimitives.Trigger
      ...
      className={cn(
        ...
        'after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-primary-base after:transition-all after:duration-200 after:ease-out data-[state=open]:after:w-full',
        // focus
        'focus:outline-none',
        // placeholder state
